...
|---|---|---:|---:|---:|---:|---:|---:|
| normal | static_baseline | 17.077% | 11.648% | 5.428% | 0.890 | 10.608% | 56.863% |
| normal | universe_ew | 17.077% | 14.863% | 2.214% | 0.890 | 10.608% | 58.824% |
| stress | static_baseline | -15.907% | -14.880% | -1.026% | -0.940 | 13.181% | 62.500% |
| stress | universe_ew | -15.907% | -20.009% | 4.102% | -0.940 | 13.181% | 62.500% |
| all | static_baseline | 11.940% | 7.616% | 4.324% | 0.582 | 17.131% | 57.627% |
| all | universe_ew | 11.940% | 9.363% | 2.576% | 0.582 | 17.131% | 59.322% |

## Scorecard

| Criterion | Passed |
|---|---|
| 1. Positive long-run excess return vs primary benchmark | Pass |
| 2. Lower stress max drawdown than static baseline | Fail |
| 3. At least two of Sharpe, Sortino, IR beat static baseline | Pass |
| 4. Excess return survives 25 bps cost robustness | Pass |
| 5. Positive stress-period excess return vs static baseline | Fail |
...
| Part 3 Subperiod | Normal / Stress / All Regime Decomposition | completed | rows=6 |
